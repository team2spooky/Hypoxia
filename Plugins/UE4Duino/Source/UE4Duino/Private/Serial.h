...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Read String", keywords = "string words text characters"), Category = "UE4Duino")
	FString ReadString(bool &bSuccess);
	/** Will read characters from Serial port until \n (newline) is found */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Read Line", keywords = "string words text characters"), Category = "UE4Duino")
	FString Readln(bool &bSuccess);
	FString ReadStringUntil(bool &bSuccess, uint8 Terminator);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Read a Float"), Category = "UE4Duino")
	float ReadFloat(bool &bSuccess);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Read an Int", keywords = "integer"), Category = "UE4Duino")
	int32 ReadInt(bool &bSuccess);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Read a Byte"), Category = "UE4Duino")
	uint8 ReadByte(bool &bSuccess);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Read Bytes"), Category = "UE4Duino")
	TArray<uint8> ReadBytes(int32 Limit = 256);

	/** Writes a string without newline to the serial port. */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Print", keywords = "write string words text characters"), Category = "UE4Duino")
	bool Print(FString String);
	/** Writes a string with newline at the end to the serial port. */
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Print Line", keywords = "write string words text characters"), Category = "UE4Duino")
	bool Println(FString String);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Write a Float"), Category = "UE4Duino")
	bool WriteFloat(float Value);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Write an Int", keywords = "integer"), Category = "UE4Duino")
	bool WriteInt(int32 Value);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Write a Byte"), Category = "UE4Duino")
	bool WriteByte(uint8 Value);
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Write Bytes"), Category = "UE4Duino")
